package com.dicoding.kailani.submission.moviecatalogue.database.provider;
...
public class MovieProvider extends ContentProvider {
    ...
    static {
        ...
        // content://com.dicoding.kailani.submission.moviecatalogue/mst_movie_favorite
        sUriMatcher.addURI(QueryHelper.FavoriteMovie.AUTHORITY, QueryHelper.FavoriteMovie.TABLE_NAME, GET_ALL_FAVORITE);

        // content://com.dicoding.kailani.submission.moviecatalogue/mst_movie_favorite/id
