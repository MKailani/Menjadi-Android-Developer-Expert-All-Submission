 ...
 */
public class EnglishToBahasaFragment extends BaseFragment implements KamusView{
    public static final String TAG = EnglishToBahasaFragment.class.getSimpleName();
    ...
    public EnglishToBahasaFragment() {}
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        kamusPresenter.loadDataEnglishToIndo();
    }


    public static EnglishToBahasaFragment newInstance() {
        EnglishToBahasaFragment fragment = new EnglishToBahasaFragment();
    ...
    public void setupToolbar() {
        if(getActivity() !=null){
            ...
            ((MainActivity)getActivity()).changeSubTitleBar(getString(R.string.nav_english_to_indonesia_title));
            ((MainActivity)getActivity()).setTvSubToolbarDesc(getString(R.string.nav_english_to_indonesia_title));
        }
    }
